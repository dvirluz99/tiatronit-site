...
export const homePageStructure = [
    ...
    },
    {
        ...
        collectionGallery: [
            ...
            { img: "AllDir/סדנאות לגיל השלישי/imge5.jpg" },
            // ... עוד תמונות
        ],
...
export const showData = {
    ...
    p1:{
        ...
        showData: {
            title: "חוהל'ה – משואה לתקומה",
            description: "סיפורה האמיתי, המופלא והמרגש של חוהל'ה ובעלה הרב זלמן, שכל משפחתו נרצחה בשואה. זהו סיפור על אמונה ותקוה, המובא לקהל באמצעות תיאטרון בובות או הצגת יחיד, יחד עם הרצאה מרתקת",
    ...
    p8:{
        ...
        showData: {
            title: 'עולה חדשה',
            description: 'ההצגה תלמד את הילדים להסתכל על חברם לגן או לכיתה בעין חיובית ויפה, להתמודד עם אכזבה וכמה חשוב לשתף את ההורים בכל דבר ההצגה מספרת את סיפורה של אילנה עולה חדשה בכיתה א',
            creatorIntro: 'ההצגה מועברת ע"י,',
            creatorName: "רונית לוז",
            creatorCredentials: "יועצת חינוכית, מטפלת CBT, ויוצרת תיאטרונית – תיאטרון בובות רגשי-חברתי.",
            audience: "מתאים לילדים מגיל 4 עד 10",
    ...
    p15:{
        ...
        vidue:{Trailer:[], customers:[],},
        arrayGallery: [
            {img: 'AllDir/סדנאות בובהתרפיה לבעלי צרכים מיוחדים/image1.jpg'},
        ],
        },
}

export const aboutData = {
    title: "קצת עלי - תיאטרון בובות רגשי חברתי",
    mainDescription: `
    ...
    testimonials: [
        ...
        {
            text: "ניכר כי המפגש היה מלמד, מעצים, ערכי ואף מרגש מאוד. הרעיון לספר את הסיפור באמצעות בובות מנגיש אותו לתלמידים.",
            linkRecId: 'rec14',
            linkP: 'p1',
            fromPresention: "חוהל'ה – משואה לתקומה",
            author: 'עליזה שלום, מנהלת בי"ס "אלומות" ב"ש'
        },
        {
            text: "ההצגה הייתה מלאה רגש, משמעות ומסרים חשובים, כולל דגש מרומם על תקווה ותקומה. מומלץ בחום!",
            linkRecId: 'rec15',
            linkP: 'p1',
            fromPresention: "חוהל'ה – משואה לתקומה",
            author: "אסתר אורליאן, פסיכולוגית, יד בנימין"
        }
    ]
};
...
export const recommendationsData = {
    ...
    id: "rec15",
    type: "recommendation",
    recommenderName: "אסתר אורליאן",
    recommenderRole: "פסיכולוגית, יד בנימין",
    date: "28.12.2025",
    relatedShow: "חוהל'ה משואה לתקומה", // לא צוין שם ההצגה המדויק, אז הכללתי לפי התוכן
    
    // תוכן ההמלצה כפי שחולץ מההודעה
    content: `
        <p>רונית הציגה את סיפורי השואה של סבא וסבתא שלה בצורה חווייתית ונוגעת, מלאה בחן ובחמימות המיוחדים שלה.</p>
        <p>היא הזמינה אותנו לראות את השתלשלות הדברים ועוצמתם דרך העיניים של הסבים, ואפשרה לנו במידת מה לחוות את הפחד, האובדן, ותחושת ההשגחה יחד איתם, כביכול בזמן אמת.</p>
        <p>ההצגה הייתה מלאה רגש, משמעות, ומסרים חשובים, כולל דגש מרומם על תקווה ותקומה. מומלץ בחום!</p>
    `,
    ...
    rec17: {
        id: "rec17",
        type: "recommendation",
        recommenderName: "תהילה יעיש",
        recommenderRole: "מנהלת תיכון, אולפנת צביה טהר",
        date: "", // לא צוין תאריך מדויק במסמך
        relatedShow: "חוהל'ה – משואה לתקומה",
        
        content: `
            <p>המלצה חמה על ההרצאה המרתקת והמעניינת של הגב' רונית לוז. המופע שילב משחק, סיפור אישי, תמונות ומצגת, וחיבר את הבנות להיסטוריה של עמ"י ולתקומה.</p>
            <p>הסיפור היה חי, נושם, מרגש עד דמעות ונוגע ללב. הבנות היו קשובות, מסוקרנות ונרגשות.</p>
            <p>זהו מופע מיוחד ברוחו המאפשר להתחבר לעבר ולהעמיק בו מתוך אמונה, מסירות ותקווה. מומלץ בחום לכל הגילאים ולכלל האוכלוסיות.</p>
        `,
    ...
    rec18: {
        id: "rec18",
        type: "recommendation",
        recommenderName: "רחל אמסלם",
        recommenderRole: "עו\"סית קלינית ומטפלת זוגית",
        date: "26.01.2026",
        relatedShow: "חוהל'ה – משואה לתקומה",
        
        content: `
            <p>תודה רבה על ההרצאה המרתקת! זכינו למסע עמוק, מרתק ומרגש אל תוך תקופת השואה.</p>
            <p>שילבת ידע היסטורי מדויק עם סיפורים אישיים ועדויות אנושיות שהעניקו לנו חיבור חי ונוגע ללב אל מאורעות השואה.</p>
            <p>הייתה זו הרצאה עוצמתית שעוררה התרגשות עמוקה והשאירה רושם מתמשך שעזר לנו להבין, לזכור ולא לשכוח!!</p>
            <p>תבורכי💕</p>
        `,
